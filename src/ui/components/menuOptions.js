...
const OptionsMenuComponent = () => {
    ...
    return (
        <div className={menu ? "menuTrue" : "menuFalse"}>
            ...
            {token ? <OptionsMenu route={'/admin'} title={"Administracion"} show={menu} icon={<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-fingerprint" viewBox="0 0 16 16">
